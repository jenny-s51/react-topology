module.exports = {
  ...
  '/topology/custom-edges/extensions': {
    id: "Custom edges",
    title: "Custom edges",
    toc: [[{"text":"Using custom edges"},{"text":"Example"}]],
    examples: ["Example"],
    section: "topology",
    subsection: "",
    source: "extensions",
  ...
  '/topology/drag-and-drop/extensions': {
    id: "Drag and drop",
    title: "Drag and drop",
    toc: [[{"text":"Drag and drop"},{"text":"Functions"}]],
  ...
  '/topology/pan-and-zoom/extensions': {
    id: "Pan and zoom",
    title: "Pan and zoom",
    toc: [[{"text":"Providing pan and zoom on the graph"},{"text":"Example"}]],
    examples: ["Example"],
    section: "topology",
    subsection: "",
    source: "extensions",
  ...
  '/topology/pipelines/extensions': {
    id: "Pipelines",
    title: "Pipelines",
    toc: [[{"text":"Using pipelines"},{"text":"Functions"}]],
